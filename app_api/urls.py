...
urlpatterns = [
    ...
    path('get_docs/',views.get_docs,name="api_get_docs"), # 获取文集的手册列表
    path('get_doc/',views.get_doc,name="api_get_doc"), # 获取单篇手册
    path('create_project/',views.create_project,name="api_create_project"), # 新建文集
    path('create_doc/',views.create_doc,name="api_create_doc"), # 新建手册
