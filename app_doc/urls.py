...
urlpatterns = [
    path('',views.project_list,name='pro_list'),# 手册首页
    #################文集相关
    ...
    path('get_pro_doc/', views.get_pro_doc, name="get_pro_doc"),  # 获取某个文集的下级手册
    path('get_pro_doc_tree/', views.get_pro_doc_tree, name="get_pro_doc_tree"),  # 获取某个文集的下级手册树数据
    ...
    path('manage_project_doc_sort/',views_import.project_doc_sort,name='project_doc_sort'), # 导入文集手册排序
    ...
    #################手册相关
    path('project-<int:pro_id>/doc-<int:doc_id>/', views.doc, name='doc'),  # 手册浏览页
    path('create_doc/', views.create_doc, name="create_doc"),  # 新建手册
    path('modify_doc/<int:doc_id>/', views.modify_doc, name="modify_doc"),  # 修改手册
    path('del_doc/',views.del_doc,name="del_doc"), # 删除手册
    path('manage_doc/',views.manage_doc,name="manage_doc"), # 管理手册
    path('diff_doc/<int:doc_id>-<int:his_id>/',views.diff_doc,name='diff_doc'), # 对比手册历史版本
    path('manage_doc_history/<int:doc_id>/',views.manage_doc_history,name='manage_doc_history'), # 管理手册历史版本
    path('move_doc/', views.move_doc, name='move_doc'), # 移动手册
    path('doc_recycle/', views.doc_recycle,name='doc_recycle'), # 手册回收站
    path('fast_pub_doc/',views.fast_publish_doc,name='fast_pub_doc'), # 一键发布手册
    path('download_doc_md/<int:doc_id>/',views.download_doc_md,name='download_doc_md'), # 下载手册Markdown文件
    path('import/doc_docx/',views_import.import_doc_docx,name="import_doc_docx"), # 导入docx手册
    #################手册分享相关
    path('share_doc/', views.share_doc, name='share_doc'),  # 私密手册分享
    path('share_doc_check/', views.share_doc_check, name='share_doc_check'),  # 私密手册验证
    path('manage_doc_share/',views.manage_doc_share,name="manage_doc_share"), # 分享手册管理
    #################手册模板相关
    path('manage_doctemp/',views.manage_doctemp,name='manage_doctemp'), # 手册模板列表
    path('create_doctemp/',views.create_doctemp,name="create_doctemp"), # 创建手册模板
    path('get_doctemp/',views.get_doctemp,name='get_doctemp'), # 获取某一个手册模板内容
    path('del_doctemp/',views.del_doctemp,name="del_doctemp"), # 删除某一个手册模板
    path('modify_doctemp/<int:doctemp_id>/',views.modify_doctemp,name="modify_doctemp"), # 修改手册模板
    #################文件管理相关
    ...
    ##############手册标签
    path('manage_doc_tag/',views.manage_doc_tag,name="manage_doc_tag"), # 手册标签管理
    path('tag_docs/<int:tag_id>/',views.tag_docs,name="tag_docs"), # 标签手册页
    path('tag_doc/<int:tag_id>/<int:doc_id>/',views.tag_doc,name="tag_doc"), # 标签手册页
    ################其他功能相关
